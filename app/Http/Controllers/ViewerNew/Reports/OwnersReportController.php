    ...
    public function __invoke(Request $request): View
    {
        ...
        $owners->setCollection($owners->getCollection()->map(function (Owner $owner) use ($ownerHas, $pivotHas, $hasCurrentColumn): array {
            ...
            return [
                ...
                'birth_date' => $ownerHas('birth_date') ? $formatDate($owner->birth_date, 'Y-m-d') : '—',
                ...
                'created_at' => $ownerHas('created_at') ? $formatDate($owner->created_at, 'Y-m-d H:i') : '—',
                'last_update' => $ownerHas('updated_at') ? $formatDate($owner->updated_at, 'Y-m-d H:i') : '—',
