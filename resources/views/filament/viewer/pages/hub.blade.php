...
function handleLogout(){if(confirm('هل تريد تسجيل الخروج؟')){localStorage.removeItem('loggedInUser');localStorage.removeItem('userRole');window.location.href='/viewer/hub';}}
function gotoProperties(e){e.preventDefault();localStorage.setItem('startPage','properties');window.location.href='/viewer/viewer-dashboard';}
